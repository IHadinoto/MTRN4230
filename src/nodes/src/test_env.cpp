...
// ========================================================================== //
    ...
    // static const std::array<double, 26> LETTER_X {0.427,0.2,0.339,0.286,0.420,0.136,0.147,0.430,0.217,0.364,0.409,0.147,0.153,0.357,0.400,0.262,0.321,0.222,0.353,0.200,0.242,0.273,0.390,0.278,0.312,0.406};
    // static const std::array<double, 26> LETTER_Y {0.3,0.245,0.148,0.234,0.150,0.037,0.396,0.400,0.350,0.367,0.015,0.327,0.176,0.196,0.200,0.286,0.300,0.184,0.259,0.430,0.088,0.392,0.430,0.024,0.417,0.075};
    
    static const std::array<double, 26> LETTER_X = {0.132, 0.132, 0.132, 0.132, 0.132, 0.132, 0.210, 0.210, 0.210, 0.210, 0.210, 0.290, 0.290, 0.290, 0.290, 0.290, 0.290, 0.375, 0.375, 0.375, 0.375, 0.375, 0.460, 0.460, 0.460, 0.460};
    static const std::array<double, 26> LETTER_Y = {0.462, 0.377, 0.287, 0.198, 0.117, 0.025, 0.426, 0.335, 0.245, 0.148, 0.060, 0.464, 0.377, 0.286, 0.196, 0.118, 0.025, 0.432, 0.340, 0.242, 0.138, 0.060, 0.378, 0.285, 0.190, 0.110};
